      ...
      <div className="grid-2-columns title-and-cards">
        <div id="w-node-d986b1c4-810f-08ae-61d9-bcbd56045c2e-cecd3d78" data-w-id="d986b1c4-810f-08ae-61d9-bcbd56045c2e"
          ...
          <div id="w-node-_9bd4dc5c-7803-8711-52a1-98d018e5c766-cecd3d78" className="mg-bottom-108px">
            ...
            <Link href="/#"><a data-w-id="c4951ffd-b0e0-6a4f-4ef9-826a734b61c1"
          ...
          <div className="w-dyn-list">
            <div role="list" className="w-dyn-items">
              <div role="listitem" className="w-dyn-item">
                <Link href="/portfolio/agency-website-development-for-dev-x"><a data-w-id="1b26b36d-7cb5-c706-7cbf-8be9a8e952bf"
                  ...
                  <div className="portfolio-project-card-text-container">
                    <div className="portfolio-project-logo-wrapper">
                      <Image layout="fill"
                        ...
                        loading="eager" alt="Agency Website Development for Dev X" />
                    </div>
                  ...
                  <Image layout="fill"
                    ...
                    loading="eager" alt="Agency Website Development for Dev X" className="portfolio-thumbnail-image" />
                </a></Link>
              </div>
            </div>
          </div>
        ...
        <div id="w-node-_6f34c543-cafb-5831-e05b-ad69d32267ce-cecd3d78" data-w-id="6f34c543-cafb-5831-e05b-ad69d32267ce"
          ...
          <div className="mg-bottom-40px w-dyn-list">
            <div role="list" className="w-dyn-items">
              <div role="listitem" className="w-dyn-item">
                <Link href="/portfolio/crypto-website-development-for-defi-x"><a data-w-id="dfdce344-53b3-260a-d1f9-cfec18bead99"
                  className="card portfolio-project w-inline-block">
                  <div className="badges-top-wrapper">
                    <div className="badge-primary small">React JS</div>
                    <div className="badge-primary small">Web Development</div>
                  ...
                  <div className="portfolio-project-card-text-container">
                    <div className="portfolio-project-logo-wrapper">
                      <Image layout="fill"
                        ...
                        loading="eager" alt="Crypto Website Development for DeFi X" />
                    </div>
                  ...
                  <Image layout="fill"
                    ...
                    loading="eager" alt="Crypto Website Development for DeFi X" className="portfolio-thumbnail-image" />
                </a></Link>
              </div>
            </div>
          </div>
          <div className="w-dyn-list">
            <div role="list" className="w-dyn-items">
              <div role="listitem" className="w-dyn-item">
                <Link href="/portfolio/trading-website-development-for-dark-x"><a data-w-id="52450725-1104-4511-dd75-3cecf21be612"
                  className="card portfolio-project w-inline-block">
                  <div className="badges-top-wrapper">
                  ...
                  <div className="portfolio-project-card-text-container">
                    <div className="portfolio-project-logo-wrapper">
                      <Image layout="fill"
                        ...
                        loading="eager" alt="Trading Website Development for Dark X" />
                    </div>
                  ...
                  <Image layout="fill"
                    ...
                    loading="eager" alt="Trading Website Development for Dark X" className="portfolio-thumbnail-image" />
                </a></Link>
              </div>
            </div>
          </div>
